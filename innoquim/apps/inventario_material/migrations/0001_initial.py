# Generated by Django 5.2.7 on 2026-01-05 07:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('materia_prima_id', models.ForeignKey(help_text='Material que se esta inventariando', on_delete=django.db.models.deletion.PROTECT, to='materia_prima.materiaprima', verbose_name='Materia Prima')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['materia_prima_id'], name='inventario__materia_d4decf_idx'), models.Index(fields=['almacen_id'], name='inventario__almacen_bbe563_idx')],
